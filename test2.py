...
if __name__ == '__main__':
    with torch.no_grad():
        ...
        save_model_to_safetensor(classification_model, "classification_model.safetensor")
        loaded_classification_model = load_model_from_safetensor(AutoModelForSequenceClassification.from_pretrained("bert-base-uncased"), "classification_model.safetensor")

        # Save and load generation model
        save_model_to_safetensor(generation_model, "generation_model.safetensor")
        loaded_generation_model = load_model_from_safetensor(AutoModelForCausalLM.from_pretrained("Deci/DeciLM-6b"), "generation_model.safetensor")
        ...
        if classification_model_sklearn:
            ...
            save_classification_model(classification_model_sklearn, "classification_model_sklearn.pkl")
            loaded_model = load_classification_model("classification_model_sklearn.pkl")
